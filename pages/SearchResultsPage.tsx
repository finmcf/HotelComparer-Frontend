...
const SearchResults: NextPage = () => {
  return (
    <div className="w-[1280px] h-[832px] relative bg-white">
      <NavBar />
      <div className="w-[393px] h-[690px] left-0 top-[43px] absolute bg-zinc-300" />
      <div className="w-[887px] h-[690px] left-[393px] top-[43px] absolute bg-stone-400">
      ...
      <div className="w-[1280px] h-[99px] left-0 top-[733px] absolute" />
    </div>
  );
};
